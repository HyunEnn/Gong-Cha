...
function MarketBoardPage() {
    ...
    return (
        <div className="absolute flex items-center justify-center">
            ...
            {/* page tab */}
            <div className="absolute flex flex-col justify-center left-[calc(1.13125rem)]">
                <div className="absolute flex items-center justify-center top-[calc(7.5rem)] p-0 w-[calc(20.25rem)] h-[calc(2.86rem)] bg-gray-100 rounded-sm text-[calc(0.8rem)]">
