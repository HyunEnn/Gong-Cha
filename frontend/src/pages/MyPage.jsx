...
function MyPage() {
    ...
    return (
        <>
            ...
            <>
            <div className="absolute flex left-[calc(1.13125rem)] top-[calc(14.5rem)] w-[calc(19.75rem)]" onClick={() => handlePlayScheduleClick()}>
                <CardForm className="flex justify-center h-full w-[calc(1.6875rem)] h-[calc(1.6875rem)] rounded-[7px]">
            ...
            <div className="absolute flex left-[calc(1.13125rem)] top-[calc(17.3125rem)] w-[calc(19.75rem)]" onClick={() => handlePlayHistoryClick()}>
                <CardForm className="flex justify-center h-full w-[calc(1.6875rem)] h-[calc(1.6875rem)] rounded-[7px]">
            ...
            <div className="absolute flex left-[calc(1.13125rem)] top-[calc(20.125rem)] w-[calc(19.75rem)]" onClick={() => handlePlayerCardClick()}>
                <CardForm className="flex justify-center h-full w-[calc(1.6875rem)] h-[calc(1.6875rem)] rounded-[7px]">
            ...
            <div className="absolute flex left-[calc(1.13125rem)] top-[calc(22.9375rem)] w-[calc(19.75rem)]" onClick={() => handleAlarmClick()}>
                <CardForm className="flex justify-center h-full w-[calc(1.6875rem)] h-[calc(1.6875rem)] rounded-[7px]">
                    <CardContent className="p-0 pt-[calc(0.125rem)]">
